...
extension Profile.Behavior: Decodable {
    public static func decode(_ json: Any) throws -> Profile.Behavior {
        return try Profile.Behavior(
            ...
            primaryKeywords: json => "attributes" => "primary_keywords",
            ...
            secondaryKeywords: json => "attributes" => "secondary_keywords",
...
extension Profile.Behavior: Sqlable {
    public static let tableLayout = [id, primaryName, primaryColorName, primaryRepresentationName, primaryRepresentationImageName, primaryKeywords, secondaryName, secondaryColorName, secondaryRepresentationName, secondaryRepresentationImageName, secondaryKeywords, groupName]
    ...
    static let primaryKeywords = Column("primaryKeywords", .text)
    ...
    static let secondaryKeywords = Column("secondaryKeywords", .text)
    ...
    public init(row: ReadRow) throws {
        try self.init(
            ...
            primaryKeywords: row.get(Profile.Behavior.primaryKeywords),
            ...
            secondaryKeywords: row.get(Profile.Behavior.secondaryKeywords),
    ...
    public func valueForColumn(_ column: Column) -> SqlValue? {
        ...
        case Profile.Behavior.primaryKeywords: return primaryBehavior.keywords
        ...
        case Profile.Behavior.secondaryKeywords: return secondaryBehavior?.keywords
...
private extension Profile.Behavior {
    init(id: Int, primaryName: String, primaryColorName: String, primaryRepresentationName: String, primaryRepresentationImageName: String, primaryKeywords: String, secondaryName: String, secondaryColorName: String, secondaryRepresentationName: String, secondaryRepresentationImageName: String, secondaryKeywords: String, groupName: String) {
        self.init(
            id: id,
